...
export class API {
    ...
    async getEvaluationChartData() {
        const dummyData = {
            ...
            datasets: [{ label: 'あなたのスコア', data: [4, 5, 3, 4, 5], backgroundColor: 'rgba(54, 162, 235, 0.2)', borderColor: 'rgb(54, 162, 235)' }, { label: '部署平均', data: [3.5, 4.2, 4.1, 3.8, 4.5], backgroundColor: 'rgba(255, 99, 132, 0.2)', borderColor: 'rgb(255, 99, 132)' }]
        };
