                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="chart-controls">
                        <div class="btn-group btn-group-sm" role="group">
                          <button type="button" class="btn btn-outline-primary active" data-chart="radar" onclick="window.app.currentPage.switchChart('radar')">
                            <i class="fas fa-chart-area me-1"></i>
                            レーダー
                          </button>
                          <button type="button" class="btn btn-outline-primary" data-chart="bar" onclick="window.app.currentPage.switchChart('bar')">
                            <i class="fas fa-chart-bar me-1"></i>
                            バー
                          </button>
                          <button type="button" class="btn btn-outline-primary" data-chart="line" onclick="window.app.currentPage.switchChart('line')">
